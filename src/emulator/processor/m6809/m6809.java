...
//cpu imports
import static emulator.processor.m6809.m6809H.M6809_FIRQ_LINE;
import static emulator.processor.m6809.m6809H.M6809_IRQ_LINE;
import static emulator.processor.m6809.m6809H.M6809_Y;
...
public class m6809  {
	...
	public static final int PULSE_LINE = 3;
    ...
    public static class m6809_Regs {
        ...
        public IIRQHandler irq_callback;
    ...
    public void CHANGE_PC() {
    	//?? Bank switching:
    	// change_pc_generic(m6809.pc & 0xFFFF, ABITS2_16, ABITS_MIN_16, 0, cpu_setOPbase16);
    	//System.out.println("CHANGE_PC: pc=0x" + Integer.toHexString(m6809.pc & 0xFFFF));
    }

    /*
    private void change_pc_generic(int pc, int abits2, int abitsmin, int shift, setopbase setop) {
    ...
    */
    ...
    /* set when LDS occurred at least once */
    public void CHECK_IRQ_LINES() {
    	...
    	//System.out.println("check IRQ lines");
 ...
 /* HJB 990225: state already saved by CWAI? */
            ...
            CHANGE_PC();
            m6809.irq_callback.handleIrq(this, M6809_FIRQ_LINE, 0);
 ...
 /* HJB 990225: state already saved by CWAI? */
            ...
            CHANGE_PC();
            m6809.irq_callback.handleIrq(this, M6809_IRQ_LINE, 0);
        }
    ...
    public int saveState(int[] state, int index) {
    	state[index++] = m6809.pc & 0xFFFF;
    	state[index++] = m6809.ppc & 0xFFFF;
    	state[index++] = m6809.u & 0xFFFF;
    	state[index++] = m6809.s & 0xFFFF;
    	state[index++] = m6809.x & 0xFFFF;
    	state[index++] = m6809.y & 0xFFFF;
    	state[index++] = m6809.dp & 0xFFFF;
    	state[index++] = m6809.a & 0xFFFF;
    	state[index++] = m6809.b & 0xFFFF;
    	state[index++] = m6809.cc & 0xFFFF;
    	state[index++] = m6809.ireg;
    	state[index++] = m6809.int_state;   	
    	return index;
    }

    public int loadState(int[] state, int index) {
    	m6809.pc = (char)(state[index++]);
    	m6809.ppc = (char)(state[index++]);
    	m6809.u = (char)(state[index++]);
    	m6809.s = (char)(state[index++]);
    	m6809.x = (char)(state[index++]);
    	m6809.y = (char)(state[index++]);
    	m6809.dp = (char)(state[index++]);
    	m6809.a = (char)(state[index++]);
    	m6809.b = (char)(state[index++]);
    	m6809.cc = (char)(state[index++]);
    	m6809.ireg = (state[index++]);
    	m6809.int_state = (state[index++]);
    	return index;
    }
    ...
    public int ROP(int addr) {
        //return cpu_readop(addr);
    	return ram.readByte(addr);
    }

    public int ROP_ARG(int addr) {
	...
	*/
    ...
    public void set_nmi_line(int state) {
        ...
        //System.out.println("M6809#" + cpu_getactivecpu() +" set_nmi_line " + state);
        if (state == CLEAR_LINE) {
            return;
        }
     ...
     * **************************************************************************
     */
    public void set_irq_callback(IIRQHandler callback) {
    ...
    public int execute(int cycles) {
        ...
        if ((m6809.int_state & (M6809_CWAI | M6809_SYNC)) != 0) {
            m6809_ICount[0] = 0;
            System.out.println("CWAI_SYNC =" + (m6809.int_state & M6809_CWAI ) + "," + (m6809.int_state & M6809_SYNC ));
        } else {
    ...
    */
    ...
    public static void illegal() {
        System.out.println("M6809: illegal opcode at 0x" + Integer.toHexString(m6809.pc));
    }
...
//        }
    ...
    public void pref11() {
        ...
        switch (ireg2) {
            ...
            /*TODO*///		default:   illegal();						break;
            default:
                System.out.println("m6809 prefix11 opcode 0x" + Integer.toHexString(ireg2));
        }
    }
